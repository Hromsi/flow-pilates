...
const sections: TermSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Отмена и перенос разовой тренировки производятся только через администратора студии: +7 (985) 714-86-30 (звонок, SMS или мессенджер MAX). Самостоятельная отмена в приложении не является основанием для автоматического возврата средств.",
      "Индивидуальные случаи обсуждаются с руководителем студии.",
    ],
  },
  {
